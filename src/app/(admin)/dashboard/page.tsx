...
function DashboardPage() {
  ...
  if (!interviews || !users || interviews instanceof Error || users instanceof Error) {
    return <LoaderUI />;
  }
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="flex items-center mb-8">
        <Link href="/schedule">
          <Button className="text-white font-semibold">Schedule New Interview</Button>
        </Link>
      </div>
            ...
            groupedInterviews[category.id]?.length > 0 && (
              <section key={category.id}>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <Badge variant={category.variant} className="text-white font-semibold">{groupedInterviews[category.id].length}</Badge>
                </div>
