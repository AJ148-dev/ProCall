...
function InterviewScheduleUI() {
    ...
    if(users instanceof Error|| interviews instanceof Error){
        return (
    ...
    const scheduleMeeting = async()=>{
        ...
        if(!formData.candidateId || formData.interviewerIds.length===0){
            toast.error("Select both candidate and at least one interviewer");
            return;
        }
        setIsCreating(true);
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button size="lg" className="text-white font-semibold">Schedule Interview</Button>
          </DialogTrigger>
          ...
          <DialogContent className="sm:max-w-[500px] h-[calc(100vh-200px)] overflow-auto">
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <Button onClick={scheduleMeeting} className="font-semibold text-white" disabled={isCreating}>
                  {isCreating ? (
                    <>
