...
function CommentDialog({ interviewId }: { interviewId: Id<"interviews"> }) {
  ...
  if (existingComments === undefined || users === undefined || existingComments instanceof Error || users instanceof Error) return null;
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} className="font-semibold text-white">Submit</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
